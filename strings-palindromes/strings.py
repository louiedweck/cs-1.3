...
def find_all_indexes(text, pattern):
    ...
    for text_index in range(len(text) - len(pattern) + 1):
        for i2 in range(len(pattern)):
            if text[text_index + i2] != pattern[i2]:
                break
            else:
                indicies.append(text_index)
    return indicies
...
def main():
    ...
    # print(find_all_indexes('executecitecuteccc', 'cute'))
    # print(find_index("hello", 'l'))
    # print(contains("absolutely", 'ly'))
